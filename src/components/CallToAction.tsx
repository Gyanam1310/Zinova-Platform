            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5">
                  <label htmlFor="name" className="text-xs font-bold uppercase tracking-widest text-primary-foreground/50">
                    Full Name
                  </label>
                  <input
                    type="text"
                    id="name"
                    placeholder="Enter your name"
                    className="w-full rounded-xl border border-primary-foreground/15 bg-white/10 px-4 py-3.5 text-sm text-white placeholder-primary-foreground/40 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 transition-all dark:border-[var(--border-color)] dark:bg-[#0f2a23] dark:text-[var(--text-primary)] dark:placeholder:text-[var(--text-secondary)]"
                  />
                </div>
                
                <div className="space-y-1.5">
                  <label htmlFor="email" className="text-xs font-bold uppercase tracking-widest text-primary-foreground/50">
                    Work Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="organization" className="text-xs font-bold uppercase tracking-widest text-primary-foreground/50">
                    Organization
                  </label>
                  <input
                    type="text"
                ...
                <div className="pt-2">
                  <AnimatedButton 
                    type="submit"
                    size="lg" 
                    className="w-full h-12 rounded-xl bg-accent hover:bg-accent/90 text-accent-foreground text-base font-bold"
                    animationType="pulse"
                    onClick={() => {
                      safeLogUserAction("CTA_CLICK", { label: "Join Movement" });
                    }}
